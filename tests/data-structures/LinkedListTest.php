...
class LinkedListTest extends TestCase {
    ...
    public function insertionSortTest00() {
        ...
        $list->add($el04);
        $list->add($el05);
        $expected = [$el04,$el01,$el05,$el02,$el00,$el03];
    ...
    public function insertionSortTest01() {
        ...
        $list->add($el04);
        $list->add($el05);
        $expected = array_reverse([$el04,$el01,$el05,$el02,$el00,$el03]);
    ...
    public function insertionSortTest02() {
        ...
        $list->add($el04);
        $list->add($el05);
        $expected = [$el01,$el04,$el03,$el00,$el05,$el02];
        $this->assertTrue($list->insertionSort());
    ...
    public function insertionSortTest03() {
        ...
        $list->add($el04);
        $list->add($el05);
        $expected = array_reverse([$el01,$el04,$el03,$el00,$el05,$el02]);
        $this->assertTrue($list->insertionSort(false));
    ...
    public function insertionSortTest06() {
        ...
        $list->add($el04);
        $list->add($el05);
        $expected = [$el05,$el01,$el03,$el04,$el02,$el00];
        $this->assertTrue($list->insertionSort());
